...
import com.example.apifun.databinding.ActivityMainBinding;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.i("aunu", "signInWithCredential:failure", task.getException());
//                            updateUI(null);
                        }
                    }
                });
...
//        updateUI(currentUser); pass values to profile activity
    }
}